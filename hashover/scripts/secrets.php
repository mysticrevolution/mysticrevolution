<?php
	...
	$encryption_key		= 'centine1a';			// Unique 8 to 32 character encryption key
	$notification_email	= 'admin@elmisterio.org';	// E-mail for notification of new comments
	$admin_nickname		= 'admin';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'centine1a';			// Password to gain admin rights
